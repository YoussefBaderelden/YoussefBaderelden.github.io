    ...
    <section id="top" className="relative min-h-screen overflow-hidden pt-24">
      ...
      <div className="mx-auto grid max-w-6xl items-center gap-12 px-5 pb-16 md:grid-cols-[1.1fr_0.9fr] md:px-8 md:pb-24">
        <div>
          ...
          >
            {profile.role}. I ship live video, sports broadcast tools, and product apps
            across iOS, Android, Windows, and web — Agora, WebRTC, NDI, and Flutter.
          </motion.p>
          <motion.div
        ...
        >
          ...
          <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-[#0c0e14]">
            ...
            <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/80 to-transparent p-5">
              <p className="font-display text-lg">Flutter Engineer</p>
              <p className="text-sm text-[#8b93a7]">TKDS Media · Cairo</p>
            </div>
          </div>
        </motion.div>
      </div>
